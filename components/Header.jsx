  ...
  return (
    <div className='w-11/12 max-w-4xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
        ...
        <motion.h3
            ...
            Hi! I', Mohd Waseeq Zafar <Image src={assets.hand_icon} alt='' className='w-6'/>
        </motion.h3>
        ...
        <motion.p 
            ...
            className='max-w-2xl mx-auto font-Ovo'>
                Backend-Focused Full Stack Developer | Specialized in Spring Boot & Cloud Infrastructure
                Experienced in building high-availability systems, efficient service communication, and scalable AWS deployments.
        </motion.p>
